...
const ERP_NAV_SECTIONS: readonly SidebarNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Master Data", to: "/inventory/master-data", icon: ClipboardList, permission: PERMISSIONS.PAGE_INVENTORY_MANAGE },
      { label: "Warehouses", to: "/inventory/warehouses", icon: Warehouse, permission: PERMISSIONS.PAGE_INVENTORY_WAREHOUSES },
  ...
  },
  {
    ...
    items: [
      { label: "Dashboard",    to: "/projects/dashboard",  icon: LayoutDashboard, end: true, permission: PERMISSIONS.PAGE_PROJECTS },
      { label: "Projects",     to: "/projects",            icon: FolderKanban,    end: true, permission: PERMISSIONS.PAGE_PROJECTS },
      { label: "Tasks",        to: "/projects/tasks",      icon: CheckSquare,     end: true, permission: PERMISSIONS.PAGE_PROJECTS },
      { label: "Kanban Board", to: "/projects/kanban",     icon: ListChecks,      end: true, permission: PERMISSIONS.PAGE_PROJECTS },
      { label: "Milestones",   to: "/projects/milestones", icon: Target,          end: true, permission: PERMISSIONS.PAGE_PROJECTS },
      { label: "Team",         to: "/projects/teams",      icon: Users,           end: true, permission: PERMISSIONS.PAGE_PROJECTS_TEAMS },
      { label: "Documents",    to: "/projects/documents",  icon: FileText,        end: true, permission: PERMISSIONS.PAGE_PROJECTS },
      { label: "Meetings",     to: "/projects/meetings",   icon: StickyNote,      end: true, permission: PERMISSIONS.PAGE_PROJECTS },
    ],
  },
  {
    heading: "P2P",
...
export function Sidebar() {
  ...
  useEffect(() => {
    ...
    // Keep the active section open when route changes.

...
const navItems = [
  ...
  { to: "/vms/create-visitor",       label: "New Visitor",          Icon: Icons.UserPlus },
  { to: "/vms/visitor-requests",     label: "Visitors",             Icon: Icons.FileText },
  { to: "/vms/approvals",            label: "Approvals",            Icon: Icons.Approvals },
  { to: "/vms/visitor-verification", label: "Visitor Verification", Icon: Icons.Shield,   aliases: ["/vms/visitor-validation", "/vms/face-registration", "/vms/face-capture"] },
  { to: "/vms/check-in-out",         label: "Check-In / Check-Out", Icon: Icons.QrCode },

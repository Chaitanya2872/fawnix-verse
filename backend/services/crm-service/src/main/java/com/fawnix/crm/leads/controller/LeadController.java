...
public class LeadController {
  ...
  @PostMapping(path = "/{id}/contact-recordings", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
  @PreAuthorize("hasAnyRole('ADMIN','SALES_MANAGER') or @leadSecurityService.canManageLead(authentication, #id)")
  public LeadDtos.LeadResponse uploadContactRecording(
      @PathVariable String id,
      @RequestPart("audio") MultipartFile audio,
      @RequestParam(required = false) Instant contactedAt,
      @AuthenticationPrincipal AppUserDetails userDetails
  ) {
    return leadService.captureContactRecording(id, audio, contactedAt, userDetails);
  }

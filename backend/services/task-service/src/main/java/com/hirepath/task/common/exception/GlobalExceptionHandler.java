...
import com.hirepath.task.common.response.ApiErrorResponse;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiErrorResponse> handleBadRequest(
    ...
    LOGGER.warn("Bad request {} {}: {}", request.getMethod(), request.getRequestURI(), exception.getMessage());
  ...
  public ResponseEntity<ApiErrorResponse> handleUnexpected(
    ...
    LOGGER.error("Unexpected error {} {}", request.getMethod(), request.getRequestURI(), exception);

package com.fawnix.identity.common.exception;

import com.fawnix.identity.common.response.ApiErrorResponse;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiErrorResponse> handleAuthentication(
    ...
    LOGGER.warn("Authentication failed for {} {}: {}", request.getMethod(), request.getRequestURI(), exception.getMessage());

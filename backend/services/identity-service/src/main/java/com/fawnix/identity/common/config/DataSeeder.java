...
public class DataSeeder implements ApplicationRunner {
  ...
  private String roleId(RoleName roleName) {
    return switch (roleName) {
      ...
      case ROLE_HR_MANAGER -> "00000000-0000-0000-0000-000000000005";
      case ROLE_RECRUITER -> "00000000-0000-0000-0000-000000000006";
      case ROLE_HIRING_MANAGER -> "00000000-0000-0000-0000-000000000007";
      case ROLE_INTERVIEWER -> "00000000-0000-0000-0000-000000000008";
      case ROLE_EMPLOYEE -> "00000000-0000-0000-0000-000000000009";
    };
  }
}
